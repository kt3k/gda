// リポジトリ直下(de 原文)と ja/ の canonical な md を docs/pages/ にコピーする。
...
for (const [srcDir, destDir] of [['..', 'docs/pages/de'], ['../ja', 'docs/pages/ja']]) {
...
console.log('synced', FILES.length * 2, 'files')
